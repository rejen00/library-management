...
public void clear(){
    ...
    private void initComponents() {
        ...
        btnissue.setBackground(new java.awt.Color(51, 255, 51));
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/blue back button60.png"))); // NOI18N
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1081, 0, 60, 60));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/student registration.jpg"))); // NOI18N
    ...
    private void btnissueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnissueActionPerformed
        if(txtid.getText().equals("")){
            ...
            try{
            pst=c.prepareStatement("UPDATE `library`.`book` SET `status` = 'Issued', issuedate = ?, due = ?,studentid =? WHERE (`id` = ?)");
