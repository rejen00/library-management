...
public class home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1280, 670, 60, 70));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 80, 270, 240));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 370, 270, 240));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 80, 270, 240));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 80, 270, 240));
        ...
        jButton7.setText("Print Student Details");
        jButton7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton7ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 690, 150, 40));

        jButton9.setBackground(new java.awt.Color(51, 51, 255));
        jButton9.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton9.setForeground(new java.awt.Color(255, 255, 255));
        jButton9.setText("Books and  Students Details");
        jButton9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton9ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 660, 270, 70));

        jButton8.setBackground(new java.awt.Color(0, 0, 255));
        jButton8.setForeground(new java.awt.Color(255, 255, 255));
        jButton8.setText("Print Book Details");
        jButton8.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton8ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 690, 130, 40));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/pang home 111.jpg"))); // NOI18N
 ...
 String query = "SELECT studentid, name, course, branch, semester FROM student";
    ...
    try (Connection conn = Connect.ConnectToDB();
        ...
        // Title
        document.add(new Paragraph("Student List", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 18)));
        document.add(new Paragraph(" ")); // Empty line

        // Create a 5-column table for: ID, Name, Course, Branch, Semester
        PdfPTable table = new PdfPTable(5);
        table.setWidthPercentage(100); // Optional: makes table full width
        ...
        while (rs.next()) {
            table.addCell(String.valueOf(rs.getInt("studentid")));
...
Connection conn = Connect.ConnectToDB();
    ...
    try {
        ...
        // Title
        Paragraph title = new Paragraph("Book List\n\n", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 18, BaseColor.BLACK));
        title.setAlignment(Element.ALIGN_CENTER);
        document.add(title);

        // Table with 9 columns
        PdfPTable table = new PdfPTable(9); // ID, NAME, Publisher, Price, Year, Status, Issue Date, Student ID, Due Date
        ...
        while (rs.next()) {
            ...
            table.addCell(rs.getString("NAME"));
            table.addCell(rs.getString("publisher"));
            table.addCell(rs.getString("price"));
            table.addCell(rs.getString("YEAR"));
            table.addCell(rs.getString("STATUS"));
            table.addCell(rs.getString("issuedate"));
            table.addCell(String.valueOf(rs.getInt("studentid")));
            table.addCell(rs.getString("due")); // Make sure this column name matches exactly
        }

        document.add(table);
        document.close();

        JOptionPane.showMessageDialog(null, "Book PDF exported successfully!");
    } catch (Exception e) {
...
new SearchBooks().setVisible(true);         // TODO add your handling code here:
