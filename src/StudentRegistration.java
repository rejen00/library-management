...
public void clear(){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 360, 60));
        ...
        jLabel6.setText("Program&Section");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 320, 239, 46));
        ...
        getContentPane().add(btnsave, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 560, 160, 50));
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        try {
            pst=c.prepareStatement("INSERT INTO `library`.`student` (`studentid`, `name`, `course`, `branch`, `semester`) VALUES (?,?,?,?,?)");
